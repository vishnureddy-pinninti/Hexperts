...
export default {
    ...
    redirectUri: process.env.NODE_ENV === 'production' ? 'https://hexperts.ingrnet.com' : 'http://localhost:3000',
    socketUri: process.env.NODE_ENV === 'production' ? 'https://hexperts.ingrnet.com' : 'http://localhost:1515',
    scopes: [
        'user.read',
        'User.ReadBasic.All',
    ],
